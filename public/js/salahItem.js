...
export default {
	...
	template: `<div v-if="prayerName !== 'CategoryId' && prayerName !== 'Date'"><div class="flex items-center space-x-2" :class="[{'text-white/80' : !isNextPrayer}, {'text-orange-400' : isNextPrayer}]">
          <span class="shrink-0">
